...
template <typename type>
Vector3<type>::Vector3(const VectorND<type, 3>& other) : VectorND<type, 2>(other), x(this->m_data[0]), y(this->m_data[1]), z(this->m_data[2])
{
}

template <typename type>
Vector3<type>::Vector3(VectorND<type, 3>&& other) noexcept : VectorND<type, 2>(std::move(other)), x(this->m_data[0]), y(this->m_data[1]), z(this->m_data[2])
{
}
